...
import com.oracleous.extention_manager.exceptions.SuperAdminNotFoundException;
...
public class InviteEmailService implements InviteService {
    ...
    @Override
    public ResponseEmail responsetoAdmin(RequestEmailForAdmin requestEmailForAdmin) {
        boolean superAdminExist = superAdminRepository.existsByEmail(
                requestEmailForAdmin.getEmail()
        );
