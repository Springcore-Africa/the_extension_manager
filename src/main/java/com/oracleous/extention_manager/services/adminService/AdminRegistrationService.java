...
//        String link = baseUrl + "/admin/register/complete-form?email=" + encodedEmail; // Changed to new endpoint        log.info("Generated registration link: {}", link);
//
...
//        adminRepository.save(admin);
//        return CompleteAdminRegistration.builder().message("Registration successful").build();
//    }
//}
...
public class AdminRegistrationService implements AdminRegistration {
    ...
    public InitiateAdminRegistration initiateAdminRegistration(AdminRegistrationRequestDto request, String superAdminEmail) {
        ...
        String encodedEmail = URLEncoder.encode(request.getEmail(), StandardCharsets.UTF_8);
        String link = baseUrl + "/admin/register/complete-form?email=" + encodedEmail; // Changed to new endpoint
